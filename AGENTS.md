...
- Crea la clase de la acción en el paquete `com.ACFMO.PizzXava.acciones`, normalmente extendiendo `ViewBaseAction`
...
<controlador nombre="TuPrimeraEntidad">
    ...
    <accion nombre="mostrarImporte" modo="detail"
        clase="com.ACFMO.PizzXava.acciones.MostrarImporte"/>
</controlador>
```

```java
package com.ACFMO.PizzXava.acciones;
...
- ✅ Coloca las clases de acción en `com.ACFMO.PizzXava.acciones`
...
```java
package com.ACFMO.PizzXava.pruebas;
...
- Crea un paquete `cuadrosmando` (ej. `com.ACFMO.PizzXava.cuadrosmando`) y coloca la clase `CuadroMando` y sus clases auxiliares en él.
